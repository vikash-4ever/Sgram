        ...
        <div className="login">
            <div className="loginWrapper">
                <div className="loginLeft">
                    ...
                    <span className="loginDesc">Connect with friends and the world around you on SGram.</span>
                </div>
                <div className="loginRight">
                    <form className="loginBox" onSubmit={handleClick}>
                        ...
                        <button className="loginRegisterButton" onClick={()=> navigate("/login")}>Log into your account</button>
                    </form>
                </div>
            </div>
        </div>
